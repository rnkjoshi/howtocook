  ...
  return (
    <div className="App">
      ...
      <center>
        ...
        <p>Powered by @Edamum & inspired by <a href="https://rinkumonani.github.io/sear-a-pe/dist/index.html" target="_blank" style={{textDecoration:"none",color:"black"}}>sear-a-pe</a></p>
      </center>
    </div>
  );
}
